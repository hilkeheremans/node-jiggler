 ...
 *
 * @param {Object|String} [addToClass] optional class this template is being defined on
 * @param {String|Array} template name of the defined template
...
R.define = function(addToClass, template, fields, options) {
  ...
  if (addTo === undefined)
    return new R.Template(template, fields);
